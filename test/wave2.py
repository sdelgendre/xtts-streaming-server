    ...
    def _write_header(self, initlength):
        ...
        if self._comptype == 'NONE':
            ...
            self._file.write(struct.pack(self._packstr,
                struct.calcsize(self._packstr) + self._datalength, 'WAVE', 'fmt ', 16,
        ...
        if self._comptype == 'ULAW':
            ...
            self._file.write(struct.pack(self._packstr,
                struct.calcsize(self._packstr) + self._datalength, 'WAVE', 'fmt ', 18, 
                WAVE_FORMAT_MULAW, self._nchannels, self._framerate,
                self._nchannels * self._framerate * self._sampwidth,
                self._nchannels * self._sampwidth,
                self._sampwidth * 8, 0, 'fact', 4, self._datalength, 'data'))
