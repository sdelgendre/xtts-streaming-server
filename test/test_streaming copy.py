...
text = "5 décembre 1911, dans les sombres catacombes de Paris. Exploitant leurs talents uniques, quelque chose d'étonnant se produisit. commença à s'effriter."
...
if __name__ == "__main__":
    ...
    """# Sauvegarder l'audio combiné dans un fichier MP3
